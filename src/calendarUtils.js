      ...
      return (
        <div>
          ...
          <p>
            ...
            to translate those “things” in the darkness into something of words,
            feelings, thoughts, and ideas. The beginning is never easy. More than
            anything in life, we as people need this. For art. For beauty. For
            poetry. For love. For souls. It all begins this way. In understanding.
          </p>
        </div>
      );
    ...
    case 3:
      return (
        <div>
          <p>Journal {count} </p>
          <p>
            The mind can be its own worst enemy sometimes… More so than any angry
            comment, uncaring action, or thoughtlessly spewed words by others to
            you.
          </p>
          <p>
            You say the worst things to yourself. You make yourself cry and you
            mean to make yourself cry. Why? Why are you so mean to yourself? The
            world can be so hurtful sometimes, so why must you stoop so low to
            even yourself?
          </p>
          <p>
      ...
      return (
        <div>
          ...
          <p>
            ...
            So love. Love not just internally. Let the love go everywhere around
            you. Stop being so afraid of getting hurt. You will gain more than
            what you could ever lose. I named my painting “What I See of You”. My
            art is a reminder of how much I love and care for people.
          </p>
          <p>
            {" "}
            Am I always going to keep others at arm&apos;s length? You will never be
      ...
      return (
        <div>
          ...
          <p>
            ...
            those “things” in the darkness into something of words, feelings,
            thoughts, and ideas. The beginning is never easy. More than anything in
            life, we as people need this. For art. For beauty. For poetry. For love.
            For souls. It all begins this way. In understanding.
          </p>
        </div>
      );
  }
...
export function headerOfdate(count) {
  return (
    <p style={{ color: "#2c2a2a", fontweight: "600" }}>
      November, {count} , 2022{" "}
    </p>
  );
}
  ...
  switch (count) {
    case 1:
      return (
        <div>
          <p>
            As I grow older I have learned things about myself that I never
            thought were possible. Things seem to change with each passing moment
            and it is sometimes hard to keep up with even myself.{" "}
          </p>
          <p>
            {" "}
            Starting graduate school has been one of the biggest decisions in my
            life and seeing where it takes me over the next two and a half years
            will be a blast, but I know it wont be without hardships.
          </p>
        </div>
      );
    ...
    case 2:
      return (
        <div>
          <p>
            {" "}
            When we have a setback, or when our illness has taken hold of us, we
            must admit it to ourselves and, when necessary, to others.
          </p>
          <p>
            {" "}
    ...
    case 3:
      return (
        <div>
          <p>
            Chances are, we never thought we would experience a mental illness;
            never thought we would become isolated or at times lose all hope;
            never thought suicide might become an obsession; never thought we
            could be institutionalized; never thought we could act so out of
            control, often against our morals or values.{" "}
          </p>
    ...
    case 4:
      return (
        <div>
          <p>
            We also probably never thought we could find hope and recover, never
            thought we could learn to cope with the illness, be reasonably content
            with ourselves, and live each day as best we can. Yet all of this can
            happen to us.{" "}
          </p>
          <p>
            {" "}
            Setbacks are normal from time to time. They do not make us weaker or
            less valued. When we feel tempted to deny our situation, let us cast
            aside our fear and pride and admit that we are having trouble.{" "}
          </p>
        </div>
      );
    ...
    default:
      return (
        <div>
          <p>
            As I grow older I have learned things about myself that I never thought
            were possible. Things seem to change with each passing moment and it is
            sometimes hard to keep up with even myself.{" "}
          </p>
          <p>
            {" "}
            Starting graduate school has been one of the biggest decisions in my
...
export function todo(count) {
  switch (count) {
    case 1:
      return (
        <div>
          <label className={elstyle.container}>
            Do Laundry
